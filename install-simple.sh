...
curl -LSfs -o ${tempfile} https://github.com/takashi/dotfiles/archive/master.zip
...
# Run installer
sudo bundle exec serverkit apply recipe.yml.erb --variables=variable-simple.yml
